...
- The plane moves a large distance towards and away from the camera in 3 frames
- Saves a .blend file that can be rendered with VisionSIM

Run from command line, for example:
    blender --background --python .\tests\blender_tests\create_fast_moving_plane_blend.py
"""
...
build_basic_scene(
    output_path="fast_moving_plane.blend",
